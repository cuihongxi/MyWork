...
void Init_NRF24L01(void)
{
    ...
    NRF24L01_Write_Reg(NRF_WRITE_REG + CONFIG, 0x0c); //配置基本工作模式的参数;PWR_UP=0,EN_CRC,16BIT_CRC,接收模式,不所有中断
...
{  
        ...
        NRF24L01_Write_Reg(NRF_WRITE_REG + CONFIG, 0x4f);//IRQ引脚不显示中断 上电 接收模式   1~16CRC校验   
        CE_OUT_1; 
