...
//模块版引脚定义
#define NRF24L01_CE_PIN           0      //RX/TX模式选择端
#define NRF24L01_IRQ_PIN         14      //可屏蔽中断端
#define NRF24L01_CSN_PIN         15      //SPI片选端
#define MOSI_PIN                 13      //SPI主机输出从机输入端
#define MISO_PIN                 12      //SPI主机输出从机输出端
//#define SCLK_PIN                 16      //SPI时钟端

#define	SCLK_MODE_INIT()			gpio16_output_conf()
...
#define MOSI_OUT_1      MYGPIO_SET(MOSI_PIN)
#define MOSI_OUT_0      MYGPIO_RESET(MOSI_PIN)
#define READ_MISO_IN    MYGPIO_READ(MISO_PIN)
#define SCLK_OUT_1      gpio16_output_set(1)
#define SCLK_OUT_0      gpio16_output_set(0)
#define CSN_OUT_0       MYGPIO_RESET(NRF24L01_CSN_PIN)
#define CE_OUT_0        MYGPIO_RESET(NRF24L01_CE_PIN)
#define CE_OUT_1        MYGPIO_SET(NRF24L01_CE_PIN)
#define READ_IRQ_IN     MYGPIO_READ(NRF24L01_IRQ_PIN)

#define CSN_OUT_1       MYGPIO_SET(NRF24L01_CSN_PIN)
